  ...
  <div class="editor-container">
    <el-form :model="form" label-width="90px">
      ...
      <el-form-item label="文章内容">
        <div style="width: 85%">
          <MdEditor
            v-model:content="(form.content as string)"
      ...
      <el-form-item>
        <el-button type="primary" class="mr-10" @click="add">添加</el-button>
...
const add = async () => {
  let input: LiveSharedCreateInput = _.pick(form.value, [
    "content",
    "weight",
    "address",
    "emotion",
  ]) as LiveSharedCreateInput;
  form.value.tags &&
  ...
  let res = await createLiveShared(input);
  console.log(res);
  if (res?.code == 200) {
    ElMessage({
      message: "添加成功",
